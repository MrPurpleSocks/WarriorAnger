...
def videoUpload(match: str, teams):
    event = match[:7]
    file = r"C:\Users\wooll\Downloads\{}\{}-{}_{}_{}-{}_{}_{}.mp4".format(event, match, teams[0], teams[1], teams[2], teams[3], teams[4], teams[5])
    multipart_form_data = {
    ...
    embed = DiscordEmbed(title="New Match Available!",
                         description="Match {} is available on WarriorAnger! you can view it at {}".format(
